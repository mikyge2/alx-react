...
describe("Testing the <Notifications /> Component", () => {
  ...
  it('doesn\'t rerender when the list prop is the same', () => {
    const wrapper = shallow(<Notifications displayDrawer={true} listNotifications={listNotifications} />)
    expect(wrapper.instance().shouldComponentUpdate(listNotifications)).to.be(false)
  })

  it('does rerender when the list prop is the different', () => {
    const sampleList = [
      { id: 1, type: "default", value: "Test value" },
      { id: 2, type: "default", value: "Test value" },
      { id: 3, type: "default", value: "Test value" },
      { id: 4, type: "default", value: "Test value" },
    ]
    const wrapper = shallow(<Notifications displayDrawer={true} listNotifications={sampleList} />)
    expect(wrapper.instance().shouldComponentUpdate(listNotifications)).to.be(false)
  })
